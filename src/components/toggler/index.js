...
export default class LayoutToggler extends React.Component {
    render() {
    return(
        <MainContext.Consumer>
            {(context) =>
            <div className="layout-toggler">
                <Button size="sm" variant="info" onClick={context.setDesignType} className="grid">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-grid" viewBox="0 0 16 16">
                    ...
                    &nbsp;&nbsp;
                <Button size="sm" variant="info" onClick={context.setDesignType} className="list">
...
LayoutToggler.contextType = MainContext;